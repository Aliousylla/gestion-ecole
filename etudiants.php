...
<br>
        ...
        <div class="main">
            ...
            <div class="details">
                <div class="recentOrders">
                    <div class="cardHeader">
                        ...
                        <a href="form.php" class="btn">Ajouter</a>
                    </div>
            ...
            <a style="text-decoration: none; background: red; color: wheat; font-size: 1.2rem; border-radius: 10px; padding: 5px 10px ;"  href="delete.php?id=<?=$e['id']?>"  onclick="return confirm('voulez-vous vraiment supprimer ?')">supprimer</a > 
            <a style="text-decoration: none; background: orange; color: wheat; font-size: 1.2rem; border-radius: 10px; padding: 5px 10px ;" href="edit.php?id=<?=$e['id']?>"  class=" btn-warning">Modifier</a > </span>
         <a style="text-decoration: none; background: green; color: wheat; font-size: 1.2rem; border-radius: 10px; padding: 5px 10px ;"href="show.php?id=<?=$e['id']?>" >Details</a >
</div>
                    </td>
                </tr>
<?php } ?>
